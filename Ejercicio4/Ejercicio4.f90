...
real(wp), allocatable :: A(:,:),y(:),r(:),y_obs(:)
integer i
real(wp) y_apr
allocate(y(25),A(25,2),r(25),y_obs(25))
!para llamar a LA_GELS necesito definir mi matriz de diseño A y mi vector de mediciones
!mi tabla de y_i
y=[5.0291, 6.5099, 5.3666, 4.1272, 4.2948, 6.1261, 12.5140, 10.0502, 9.1614, 7.5677, &
...
do i = 1,25                !armo la matriz de diseño
   A(i,1) = 1
   A(i,2) = i
enddo
